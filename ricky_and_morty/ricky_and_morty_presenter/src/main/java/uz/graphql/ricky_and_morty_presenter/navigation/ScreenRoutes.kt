...
sealed class ScreenRoutes(val route: String) {
    ...
    sealed class Character(val route: String) {
        data class CharactersListDetailsScreen(val idsListGson: String) : Character("characters_list_details_screen?${MoveIdConstants.moveCharactersIdsList}={$idsListGson}")
