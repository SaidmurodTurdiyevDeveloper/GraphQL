...
/**
 * Created by Saidmurod Turdiyev (S.M.T) on 2/22/2023 3:41 PM for Ricky And Morty.
 */
@ExperimentalFoundationApi
@Composable
fun ItemViewEpisode(
    item: EpisodesListData,
    ...
    Card(
        ...
        )
        {
            ...
            Row(
                ...
                Text(text = "Episode", fontSize = 16.sp)
                Text(text = item.episode, fontSize = 16.sp)
            }
            Spacer(modifier = Modifier.height(12.dp))
            Row(
                modifier = Modifier
