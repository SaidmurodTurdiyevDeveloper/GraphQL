...
//            navController.navigate(route = ScreenRoutes.Location.LocationDetailsScreen.route)
//        })
//        Text(text = "Locations", modifier = Modifier.clickable {
//            navController.navigate(route = ScreenRoutes.Location.LocationsListDetailsScreen.route)
//        })
//    }
}